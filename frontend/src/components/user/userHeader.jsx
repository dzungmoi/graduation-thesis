        ...
        <Fragment>
            <nav className="navbar">
                ...
                <ul className="nav-links">
                    ...
                    <li><NavLink to="/cafe-variety" className={({ isActive }) => isActive ? "active" : ""}>Giống Cafe</NavLink></li>
            ...
            <div className={`sidebar-toggle ${sidebarOpen ? 'open' : ''}`}>
                ...
                <ul>
                    ...
                    <li><NavLink to="/cafe-variety" onClick={closeSidebar}>Giống Cafe</NavLink></li>
