  ...
  return (
    <div className="sidebar">
      ...
      <ul className="menu">
        ...
        <li className={isActive("/admin/cafe-management") ? "active" : ""} onClick={() => navigate("/admin/cafe-management")}>
          <FaSeedling className="icon" /> Quản lý giống cà phê
        </li>

        <li className={isActive("/admin/pest-diseases-management") ? "active" : ""} onClick={() => navigate("/admin/pest-diseases-management")}>
          <FaBug className="icon" /> Quản lý sâu bệnh
        </li>

        <li className={isActive("/admin/cultivation-management") ? "active" : ""} onClick={() => navigate("/admin/cultivation-management")}>
          <FaBook className="icon" /> Quản lý quy trình canh tác
        </li>

        <li className={isActive("/admin/farming-model-management") ? "active" : ""} onClick={() => navigate("/admin/farming-model-management")}>
          <FaLayerGroup className="icon" /> Mô hình canh tác
        </li>

        <li className={isActive("/admin/farm-review") ? "active" : ""} onClick={() => navigate("/admin/farm-review")}>
          <FaSeedling className="icon" /> Đánh giá nông trại
        </li>
      </ul>
