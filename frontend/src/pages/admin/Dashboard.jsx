...
import { listUsers, getAllCafe, getAllPestDisease, getTopPestPredictions } from "../../services/api";
...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [users, cafe, pests, predictions] = await Promise.all([
                    listUsers(),
                    getAllCafe(),
                    getAllPestDisease(),
                ...
                setStats({
                    ...
                    cafeCount: cafe.data?.cafeList?.data?.length || 0,
